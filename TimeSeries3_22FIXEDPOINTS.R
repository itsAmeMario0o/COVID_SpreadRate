...
NoChplot <- ggplot() + 
  geom_line(data = dfTimeSK, aes(x = day, y = inf, color = "blue") ) +
  geom_point(data = dfTimeSK, aes(x = day, y = inf, color = "blue") ) +
  geom_line(data = dfTimeUS, aes(x = day, y = inf, color = "green")) +
  geom_point(data = dfTimeUS, aes(x = day, y = inf, color = "green")) +
  geom_line(data = dfTimeIt, aes(x = day, y = inf, color = "red")) +
  geom_point(data = dfTimeIt, aes(x = day, y = inf, color = "red")) +
  xlab('Day') +
  ylab('Infected') +
  view_follow(fixed_y = TRUE) +
